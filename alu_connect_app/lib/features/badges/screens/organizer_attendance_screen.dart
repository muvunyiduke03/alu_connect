...
///
/// Usage from Organizer Dashboard or Opportunity Details:
///   Navigator.push(context, MaterialPageRoute(builder: (_) =>
///     OrganizerAttendanceScreen(
///       eventId: event.id,
///       eventName: event.title,
///       eventType: 'workshop', // 'workshop'|'hackathon'|'leadership'|'community'|'startup'
...
class OrganizerAttendanceScreen extends StatefulWidget {
  ...
  /// Falls back to mock data when null (for demo).
  ...
  void initState() {
    ...
    _attendees = widget.rsvpedAttendees ??
        [
          ...
          EventAttendee(
              studentId: 'stu_004',
              studentName: 'Jean-Paul Hakizimana',
              cohort: 'Kigali 2024'),
          EventAttendee(
              studentId: 'stu_005',
          ...
          Padding(
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                ...
                hintStyle:
                    const TextStyle(color: Color(0xFF5C6289), fontSize: 14),
                prefixIcon: const Icon(Icons.search,
                    color: Color(0xFF5C6289), size: 20),
                filled: true,
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                ...
                TextButton(
                  onPressed: () =>
                      _toggleAll(_markedCount < _attendees.length),
                  style: TextButton.styleFrom(padding: EdgeInsets.zero),
                  child: Text(
                    _markedCount < _attendees.length
                        ? 'Select all'
                        : 'Deselect all',
                    style: const TextStyle(
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          color: isPresent
              ? const Color(0xFF50C878).withAlpha(25)
        ...
        child: Row(
          children: [
            ...
            AnimatedContainer(
              ...
              decoration: BoxDecoration(
                color:
                    isPresent ? const Color(0xFF50C878) : Colors.transparent,
