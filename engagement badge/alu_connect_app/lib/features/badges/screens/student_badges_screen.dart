...
/// Reached from the Profile tab in the team's app shell.
///
/// INTEGRATION (team):
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () {
              // TODO: integrate share_plus when team adds it
      ...
      body: Consumer<BadgesProvider>(
        builder: (context, provider, _) {
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    ...
                    style: const TextStyle(color: Color(0xFF8A91B4), fontSize: 14),
                  ),
          ...
          return RefreshIndicator(
            ...
            onRefresh: () => provider.loadBadgesForStudent(widget.studentId),
            child: ListView(
              ...
              children: [
                ...
                if (provider.studentBadges.isEmpty)
                  ...
                  ...provider.studentBadges.map((b) => BadgeCard(badge: b)),
              ],
            ),
          );
        },
