...
/// BadgeCard — displays a single earned badge.
...
class BadgeCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final config = BadgeModel.typeConfig[badge.eventType] ??
        BadgeModel.typeConfig['community']!;
                ...
                Row(
                  children: [
                    ...
                    if (badge.isVerified) ...[
                      ...
                      // FIX: removed inner const Row with non-const children warning
